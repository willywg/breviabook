...
Rules that distinguish Brevia from the reference repos:
...
from brevia.ir.models import Block, Document
...
class Chunker:
    """Splits a :class:`~brevia.ir.models.Document` into chapter-bounded chunks."""
